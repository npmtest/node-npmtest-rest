...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-rest/node_modules/rest/util/delay.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-rest/node_modules/rest/util/delay.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-rest/node_modules/rest/util/</a> &#187; delay.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function delay(wait, promiseOrValue) {</span>
<span class="cstat-no" title="statement not covered" >	return Promise.resolve(promiseOrValue).then(<span class="fstat-no" title="function not covered" >function (value) {</span></span>
